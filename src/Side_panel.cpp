// src/main.cpp - Enhanced 3D Model Viewer with Centered Layout
...
static float topPanelHeight = 200.0f;
static float bottomPanelHeight = 200.0f;
static float leftPanelWidth = 280.0f;
static float rightPanelWidth = 280.0f;
...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Set viewport for OpenGL rendering
        glViewport(
            static_cast<int>(viewportPos.x),
            static_cast<int>(mainViewport->Size.y - viewportPos.y - viewportSize.y),
